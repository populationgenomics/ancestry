...
def run_spearman_correlation_scatter(
    ...
    os.path.join(geneloc_df.to_csv(output_prefix + f'_gene_SNP_pairs_{idx}.tsv'))
    ...
    os.path.join(residual_df.to_csv(output_prefix + f'_log_residuals_{idx}.tsv'))
...
def main(
    ...
    corr_result_output_path = output_prefix + '_correlation_results.csv'
