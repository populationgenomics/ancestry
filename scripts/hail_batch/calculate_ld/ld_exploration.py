...
LD_MATRIX = bucket_path('kat/v0/ld_matrix_full_filtered02_biallelic.ht/')
TOB_LOCUS_INFO = 'gs://cpg-tob-wgs-test/kat/v0/tob_locus_info_biallelic.ht/'
...
def query():
    ...
    ht_agg.write(
        'gs://cpg-tob-wgs-test/kat/v0/ld_matrix_aggregated_table02_biallelic.ht'
    )
    ...
    plot_filename_html = output_path(f'ld_variants_across_genome_biallelic.html', 'web')
